...
extension ADSPublishArticleVC {
    func setUpUI() {
        ...
        coverBtn.snp.makeConstraints { make in
            ...
            make.top.equalTo(coverLabel.snp.bottom).offset(8)
        ...
        uploadLabel.snp.makeConstraints { make in
            make.left.equalTo(15)
            make.top.equalTo(coverBtn.snp.bottom).offset(10)
        }
        
        bgView.addSubview(photoOneBtn)
        ...
        bgView.addSubview(photoTwoBtn)
        photoTwoBtn.snp.makeConstraints { make in
            make.left.equalTo(photoOneBtn.snp.right).offset(13)
            make.top.equalTo(photoOneBtn)
            make.width.height.equalTo(79)
        }
        
        bgView.addSubview(photoThreeBtn)
        photoThreeBtn.snp.makeConstraints { make in
            make.left.equalTo(photoTwoBtn.snp.right).offset(13)
            make.top.equalTo(photoOneBtn)
            make.width.height.equalTo(79)
        }
        ...
        titleLabel.snp.makeConstraints { make in
            make.left.equalTo(15)
            make.top.equalTo(photoOneBtn.snp.bottom).offset(18)
        }

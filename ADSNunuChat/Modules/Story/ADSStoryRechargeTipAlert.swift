//
//  ADSStoryRechargeTipAlert.swift
//  ADSNunuChat
//
...
class ADSStoryRechargeTipAlert: ADSBaseViewController {

    var rechargeObservable: Observable<Void> {rechargeRelay.asObservable()}
    private let rechargeRelay: PublishRelay<Void> = .init()
    ...
    lazy var topImage: UIImageView = {
        ...
        image.image = UIImage(named: "story_recharge_tip")
        return image
    }()
    ...
    lazy var contentLabel: UILabel = {
        ...
        lab.text = " You don't have enough coins, please recharge now."
        lab.textColor = .black
...
// MARK: 弹窗协议
extension ADSStoryRechargeTipAlert: ADSAlertViewAnimator {}
